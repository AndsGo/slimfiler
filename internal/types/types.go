...
type CloudFileInfo struct {
	...
	// Provider ID | 提供商的 ID
	ProviderId *uint64 `json:"providerId,optional" validate:"required"`
	// Tag ID | 标签 ID
...
type StorageProviderInfo struct {
	...
	// Set this to `true` to force the request to use path-style addressing, | 将其设置为 `true` 可强制请求使用路径样式寻址，
	S3ForcePathStyle *bool `json:"s3ForcePathStyle,optional"`
}
